  ...
  <div>
    ...
    <form method="post" @submit.prevent="updateProfile">
      ...
      <div>
        ...
        <input type="avatar" id="avatar" placeholder="Avatar" v-model="avatar" />
        </div>
        <label for="Biographie"></label>
        <input type="text" id="bio" placeholder="courte biographie" v-model="comment" />
        <!--type="text" id="comment" placeholder="Commentaire" v-model="comment" />-->
        </div>
